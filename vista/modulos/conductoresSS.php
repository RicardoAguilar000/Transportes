    ...
    <div class="container-fluid my-5">
      ...
      <div class="row carru">
        <div class="col-9 m-auto">
          ...
          <?php
                        $sql = "SELECT nombre, foto, numeroLicencia, experiencia FROM conductores";
            ...
            <div class="item">
              <div class="card border-0 ">
                <div class="card-body">
                  ...
                  <h5 class="n-expert">Numero de licencia : <?php echo $numeroLicencia; ?></h5>
                  <h5 class="n-expert">Experiencia : <?php echo $experiencia; ?> años</h5>
